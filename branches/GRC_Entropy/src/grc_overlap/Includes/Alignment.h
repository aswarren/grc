...
public:
	...
	Alignment(long St=0, long Sp=0, double B=0, string ES="none", long AL=0, long QASt=0, long QASp=0, double MxBit=0){ // parameterized constructor1
		Start=St;
		Stop=Sp;
		Bit=B;
		EScore=ES;
	...
	int GetInfo(long& ALen, double& BScore, string& EScr, double& EVal, long& HB, long& LB, double& MxBit, long& QAStart, long& QAStop, double& RelB, long& Strt, long& Stp){
		ALen=ALength;
		BScore=Bit;
		EVal=EValue;
		HB=HighBase;
