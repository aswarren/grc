...
//The intent of the modifications is to provide the number of AA's deemed low complexity when using
...
// and 25 rows.
struct PSSMatrix //MODIFIED BY ANDREW
{
    int4 NumLow;//the number of low complexity aminoacids in the query sequence //MODIFIED BY ANDREW
    int4 length;
    int4 strandLength;
	int4 highestValue;
	int4 lowestValue;
