...
//********************************MODIFIED*******************************************
//This source file has been modified from its origninal version by Andrew Warren anwarren@vt.edu on 08/16/06
//Modified lines are those marked by "MODIFIED BY ANDREW"
//The intent of the modifications is to change default location of .ncbirc file for fsa blast
//********************************MODIFIED*******************************************
